...
const Input: React.FC<InputProps> = ({ label, description, className, ...props }) => {
  ...
  const baseClasses: string = "block w-full rounded-md border-gray-200 px-4 py-3 text-sm focus:border-emerald-500 focus:ring-emerald-500 disabled:pointer-events-none disabled:opacity-50"
